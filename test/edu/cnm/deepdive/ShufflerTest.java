...
class ShufflerTest {
  ...
  @Test
  void shuffleByte() {
    byte[] source = {1, 2, 3, 5, 6, 8, 7, 9, 10 };
  ...
  @Test
  void shuffleChar() {
    char[] source = {1, 2, 3, 5, 6, 8, 7, 9, 10 };
  ...
  @Test
  void shuffleDouble() {
    double[] source = {1, 2, 3, 5, 6, 8, 7, 9, 10 };
  ...
  @Test
  void shuffleLong() {
    long[] source = {1, 2, 3, 5, 6, 8, 7, 9, 10 };
  ...
  @Test
  void shuffleShort() {
    short[] source = {1, 2, 3, 5, 6, 8, 7, 9, 10 };
  ...
  @Test
  void shuffleT() {
    Integer[] source = {1, 2, 3, 5, 6, 8, 7, 9, 10 };
  ...
  @Test
  void shuffleFloat() {
    float[] source = {1, 2, 3, 5, 6, 8, 7, 9, 10 };
